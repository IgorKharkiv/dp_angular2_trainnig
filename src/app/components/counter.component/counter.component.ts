...
export class CounterComponent {
  ...
  // interval id
  private couterIntervalId:NodeJS.Timer;
  private couterTimeOutId:NodeJS.Timer;
  ...
  public counterTimeOut():void{
    this.couterTimeOutId = setTimeout(()=>{
      this.autoIncrement();
    }, this.configTimeout);
  }
  ...
  public autoIncrement():void{
    ...
    this.couterIntervalId = setInterval(() => {
      this.increment(true);
    }, this.configInterval);
  ...
  // interval killer
  public killInterval(id?:NodeJS.Timer):void{

    let _id:NodeJS.Timer | undefined = id;
    let intervals:Array<NodeJS.Timer> = [ this.couterIntervalId, this.couterTimeOutId ];
